...
{
    public class HighlightLineWithSelectBranchCommand : HighlightCommand
    {
        private readonly HighlightSelectBranch[] _branchSelectors;

        public HighlightLineWithSelectBranchCommand(StringBuilder stringBuilder, string highlightedString, HighlightSelectBranch[] branchSelectors) : base(stringBuilder, highlightedString)
        {
